---
title: Web
description: The Web implementation — no native module, just the DOM. video to seek, canvas to capture.
---
...
**Source:** [`src/index.web.ts`](https://github.com/pythonsst/react-native-nitro-thumbnail/blob/main/src/index.web.ts)
...
resolves to [`src/index.ts`](https://github.com/pythonsst/react-native-nitro-thumbnail/blob/main/src/index.ts) on iOS/Android and to
[`src/index.web.ts`](https://github.com/pythonsst/react-native-nitro-thumbnail/blob/main/src/index.web.ts) on web — automatically, with **no
...
works unchanged. See [error handling](/guides/error-handling).
...
[`__tests__/web.test.ts`](https://github.com/pythonsst/react-native-nitro-thumbnail/blob/main/__tests__/web.test.ts), with lightweight fakes for
