---
title: Android
description: The Android implementation — pure Kotlin, MediaMetadataRetriever, BitmapFactory. No Java bridge.
---
...
<Callout type="info">Pure Kotlin, `MediaMetadataRetriever`, `BitmapFactory`. No Java bridge.</Callout>

**Source:** [`HybridThumbnail.kt`](https://github.com/pythonsst/react-native-nitro-thumbnail/blob/main/android/src/main/java/com/margelo/nitro/nitrothumbnail/HybridThumbnail.kt) ·
...
- `enforceLimit` lists the folder, maps each file to a `(path, size, lastModified)`
  ...
  `ThumbnailEncoderKt.filesToEvict`. See [caching](/guides/caching).
...
- Pure Kotlin helpers are covered by JUnit:
  [`ThumbnailSizeTest.kt`](https://github.com/pythonsst/react-native-nitro-thumbnail/blob/main/android/src/test/java/com/margelo/nitro/nitrothumbnail/ThumbnailSizeTest.kt)
  and
  [`ThumbnailEvictionTest.kt`](https://github.com/pythonsst/react-native-nitro-thumbnail/blob/main/android/src/test/java/com/margelo/nitro/nitrothumbnail/ThumbnailEvictionTest.kt).
...
- End-to-end verification runs through the [`example/`](https://github.com/pythonsst/react-native-nitro-thumbnail/tree/main/example) app.

<Callout type="info">**Emulator note:** some emulator GPU configurations can't render the RN Fabric
...
`run-as … cat`) and logcat rather than a screenshot.</Callout>
